...
//{'class': 'Boss', 'Description' : 'Darloki has high armor and recovers health over time.', 'hp' : 50000, 'speed' : 160, 'armor' : 100, 'color': "#c0ffee", 'size' : 80, 'attraction' : 300, 'value' : 1000, 'tile' : {x: 0,y: 0}, 'lives': 10,'abilities' : [{"ability" : "Heal", "value" : 250, "frequency" : 700}]}
	...
	constructor() {
		...
		this.path = null;
		this.tile = {x: -144,y: -192}; //image offset
		this.name = "Earanours";
		this.spawn_count = 9;
		this._isdead = false;
		this.description = "Delzoun Syndicate's Trojan horse. Once destroyed it releases a group Gurhabs."
		this.special_1 = "<span style='color:green'>Spawns a group of Gurhabs </span>upon death";
		this.special_2 = "";
	}
