...
//rename attraction to spread.
	...
	constructor() {
		...
		this.path = null;
		this.tile = {x: -144,y: -194}; //image offset
		this.name = "Gurhab";
		this.description = "1-star ranking soldier in the Delzoun warfleet, relatively well armoured."
		this.special_1 = "";
		this.special_2 = "";
	}
