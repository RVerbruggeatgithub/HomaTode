class Sonicwave extends Weapon {
	constructor() {
		super();
		...
		this.accuracy = 40; //the higher this number the more tolerance for hitting opponent. Put this to low and you wont hit anything..
		this.freeze_duration = 250;
		this.weapon_timing = 3000;
		this.projectile_speed = 8;
	}
	...
	action() {
		...
		var step = this.projectile_speed //Maximum distance/hypotenuse
		  ...
		  draw: function(progress) {		
			...
			var move_top = src_y_ + new_move_y;
				...
				if (count % 8 === 0 ) {
					...
					projectile_gui_location.clone().appendTo( "body" ).fadeOut(500, function() {
						$(this).remove(); 
					});
